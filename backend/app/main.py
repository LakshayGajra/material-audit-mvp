...
from app.api import contractors, materials, production, finished_goods, bom, anomalies, auth
from app.api.v1 import warehouses, suppliers, purchase_orders, goods_receipts, unit_conversions, issuances, rejections, thresholds, dashboard, reports, finished_goods_receipts, inventory_checks, stock_transfers, contractor_portal
